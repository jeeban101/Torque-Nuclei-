...
ui,_ = loadUiType("Torque(Nuclei).ui")  # This will load the main ui file
...
class MainApp(QMainWindow,ui):  # Class to create main window
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Torque (Nuclei)")# Set the title as "Troque (Nuclei)
        #calling the method
        self.UI() # window UI
        self.handle_button()
        self.handle_check()
    ...
    # method for Troque UI
    def UI(self):
        style = open("Torque.css","r") #Connect to Troque.css
        style = style.read()
    ...
    def browse_wordlist(self):#method for browse wordlist
        try:
            ...
            QMessageBox.about(self,"Torque(Nuclei)","File Not Selected")#error message
    ...
    def browse_file_checksum(self):
        try:
            ...
            QMessageBox.about(self,"Torque(Nuclei)","File Not Selected")
